...
class MatrixFormActivity : ComponentActivity() {
        ...
        setContent {
            MatrixAnywhereTheme {
                Surface(
                    ...
                    MatrixFormOutline(intent = intent, matrixFormActivity = this)
                }
            }
        }
    }
...
fun MatrixFormOutline(
    intent: Intent,
    matrixFormActivity: MatrixFormActivity
) {
    Column {
        ...
        Row(
            ...
            Button(
                modifier = Modifier
                    .testTag(SUBMIT_BACK)
                    .fillMaxWidth(0.5f),
                onClick = { matrixFormActivity.finish() }) {
                Text(text = "Back")
            }
            Button(
                onClick = {
...
fun MatrixFormOutlineDemo() {
    return MatrixFormOutline(intent = Intent(), matrixFormActivity = MatrixFormActivity())
}